...
import { FileText, Calendar, FileSearch, Trash2, ChevronDown, Home, ArrowLeft } from "lucide-react";
...
import { TimeoutModal } from "@/components/dashboard/TimeoutModal";
...
export default function DashboardPage() {
    ...
    const [currentView, setCurrentView] = useState<ViewType>("structure");
                    ...
                    <motion.div
                        ...
                        <motion.div
                            ...
                            <p className="text-neutral-400 mb-6">
                                Are you sure you want to delete &ldquo;{activeContract?.filename}&rdquo;? This action
                                cannot be undone.
                            </p>
                                        ...
                                        {contracts.map((contract) => (
                                            <button
                                                ...
                                                className={`w-full px-4 py-3 text-left hover:bg-neutral-700 transition-colors flex items-center gap-3 ${
                                                    activeContract?.contractId === contract.contractId
                                                        ? "bg-indigo-600"
                                                        : ""
                                                }`}>

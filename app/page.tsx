    ...
    const features = [
        {
            ...
            description:
                "Visual Gantt charts automatically generated from PDF text. Every date, every milestone, every risk—visible at a glance.",
            stat: "10x",
        ...
        },
        {
            ...
            title: "Risk Radar",
            description:
                "Repercussion analysis for every missed date. Know the exact penalty before the breach happens.",
            stat: "99%",
        ...
        },
        {
            ...
            description:
                "Track contract value leakage in real-time. Automated alerts for renewal windows and payment milestones.",
            stat: "$2.4M",
            ...
            <nav className="fixed top-0 w-full z-50 bg-neutral-950/80 backdrop-blur-xl border-b border-neutral-800/50">
                <div className="container mx-auto px-6 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        <Image src="/sirion-logo.svg" alt="Sirion Logo" width={93} height={20} className="rounded-lg" />
                    ...
                    <div className="flex items-center gap-3">
                        <motion.button
                            ...
                            className="px-4 py-2.5 bg-neutral-800 hover:bg-neutral-700 rounded-lg font-semibold flex items-center gap-2 transition-all text-white">
                        ...
                        <Link href="/dashboard">
                            <motion.button
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="px-6 py-2.5 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-lg font-semibold flex items-center gap-2 hover:shadow-lg hover:shadow-indigo-500/50 transition-all text-white">
                ...
                <div className="container mx-auto max-w-6xl">
                    <motion.div
                        ...
                        <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold leading-tight">
                            <span className="text-white">Stop Managing Contracts</span>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8">
                            <Link href="/dashboard">
                                <motion.button
                                    whileHover={{ scale: 1.05 }}
                                    whileTap={{ scale: 0.95 }}
                                    className="px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl font-bold text-lg flex items-center gap-3 hover:shadow-2xl hover:shadow-indigo-500/50 transition-all text-white">
            ...
            <section className="py-20 px-6 bg-gradient-to-b from-neutral-950 to-neutral-900">
                <div className="container mx-auto max-w-7xl">
                    <motion.div
                        ...
                        <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">The $18 Billion Problem</h2>
                        <p className="text-xl text-neutral-400 max-w-2xl mx-auto">
                            Every year, Fortune 500 companies lose billions to contract mismanagement. These are the
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {painPoints.map((point, index) => (
                            <motion.div
                                ...
                                <div
                                    className={`absolute inset-0 bg-gradient-to-br ${point.gradient} opacity-10 group-hover:opacity-20 rounded-2xl transition-opacity blur-xl`}
                                />
                                <div className="relative bg-neutral-900/90 backdrop-blur-sm border border-neutral-800 rounded-2xl p-8 h-full hover:border-neutral-700 transition-colors">
                                    <div
                                        className={`w-16 h-16 bg-gradient-to-br ${point.gradient} rounded-xl flex items-center justify-center mb-6`}>
                                        {point.icon}
                                    </div>
                                    <h3 className="text-2xl text-white font-bold mb-3">{point.title}</h3>
                    ...
                    <motion.div
                        ...
                        <div className="relative bg-gradient-to-br from-neutral-900 to-neutral-800 border border-neutral-700 rounded-3xl p-12 text-center">
                            ...
                            <p className="text-xl text-neutral-300 mb-8 max-w-2xl mx-auto">
                                Join the Fortune 500 companies using Sirion to prevent contract breaches and protect
                                value.
                            </p>
                            <Link href="/dashboard">
                                <motion.button
                                    whileHover={{ scale: 1.05 }}
                                    whileTap={{ scale: 0.95 }}
                                    className="px-10 py-5 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl font-bold text-lg flex items-center gap-3 mx-auto hover:shadow-2xl hover:shadow-indigo-500/50 transition-all text-white">
                                    Enter Command Center
                                    <ArrowRight className="w-5 h-5" />
                                </motion.button>
                            </Link>

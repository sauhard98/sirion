            ...
            <div className="p-6 space-y-4">
              <div className="flex items-start gap-3 p-4 bg-amber-500/10 border border-amber-500/20 rounded-xl">
                ...
                <div className="text-sm text-neutral-300">
                  ...
                  <p>This application is hosted on free infrastructure that has a 10-second timeout limit for API requests. Your contract analysis exceeded this time limit.</p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <div className="flex items-start gap-3 p-3 bg-neutral-800/50 rounded-lg">
                    <div className="w-6 h-6 bg-indigo-600 rounded-full flex items-center justify-center flex-shrink-0 text-xs font-bold text-white">1</div>
                    <div className="text-sm text-neutral-300">
                      <p className="font-medium text-white">Test locally</p>
                      <p>Run the application on your local machine where there are no timeout restrictions</p>
                    </div>
                  </div>

                  <div className="flex items-start gap-3 p-3 bg-neutral-800/50 rounded-lg">
                    <div className="w-6 h-6 bg-indigo-600 rounded-full flex items-center justify-center flex-shrink-0 text-xs font-bold text-white">2</div>
                    <div className="text-sm text-neutral-300">
                      <p className="font-medium text-white">Use the cached test contract</p>
                      <p>Download our pre-configured test contract that returns instant cached results</p>
                    </div>
                  </div>
                </div>
              </div>
